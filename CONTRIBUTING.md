...
refactor/improve-solution-structure
```
...
- Check if an existing issue already exists
- Create a new issue for new tasks
- Add proper labels and milestone
- Assign the issue to yourself before working
